...
import { ActiveAreaDeleteConfirmation } from "./ActiveAreaDeleteConfirmation";
        ...
        isConfirmingDelete ? (
          ...
          >
            ...
            <button
              type="button"
              disabled={isSaving}
              className={`${itemClassName} text-danger enabled:hover:bg-danger-soft disabled:opacity-60`}
